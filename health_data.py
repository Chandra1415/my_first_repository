...
data = {
    "Duration": [60, 60, 60, 45, 45, 60, 60, 450, 30, 60, 60, 60, 60, 60, 60, 60, 60, 60, 45, 60, 45, 60, 45, 60, 45,
    ...
    "Pulse": [110, 117, 103, 109, 117, 102, 110, 104, 109, 98, 103, 100, 100, 106, 104, 98, 98, 100, 90, 103, 97, 108,
              100, 130, 105, 102, 100, 92, 103, 100, 102, 92],
    "Maxpulse": [130, 145, 135, 175, 148, 127, 136, 134, 133, 124, 147, 120, 120, 128, 132, 123, 120, 120, 112, 123,
...
# Find row indices where all columns have NaN values
empty_rows = df[df.isnull().all(axis=1)].index

for col in df.columns:
    null_rows = df[df[col].isnull()].index.tolist()
    if null_rows:  # Only print columns with null values
        print(f"Rows with null values in '{col}': {null_rows}")
